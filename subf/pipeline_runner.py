...
#     jq_path = os.path.join(tools_dir, f'jq{suffix}')
...
#     with open(dnsx_out, 'r') as dx_in, open(httpx_out, 'w') as full_out:
#         jq = subprocess.Popen(
#             [jq_path, "-r", ".host"],
#             stdin=dx_in,
...
#             stdin=jq.stdout,
#             stdout=full_out,
#             cwd=tools_dir  # ensure correct directory context
#         )
#         httpx.wait()
...
#     # Example: run_full_pipeline("iitm.ac.in")
import subprocess
import os
import json
